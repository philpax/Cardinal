...
fn main() {
    ...
    build.define("init", "init__Algoritmarte");
    ...
    // Glob Algoritmarte/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("Algoritmarte/src"), &filter_out, &plugins_dir, &mut build, 0);
