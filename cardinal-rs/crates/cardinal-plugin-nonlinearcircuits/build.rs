...
fn main() {
    ...
    build.define("init", "init__nonlinearcircuits");
    ...
    // Glob nonlinearcircuits/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("nonlinearcircuits/src"), &filter_out, &plugins_dir, &mut build, 0);
