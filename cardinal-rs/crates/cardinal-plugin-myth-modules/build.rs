...
fn main() {
    ...
    build.define("init", "init__myth_modules");
    ...
    // Glob myth-modules/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("myth-modules/src"), &filter_out, &plugins_dir, &mut build, 0);
