...
fn main() {
    ...
    build.define("init", "init__WhatTheRack");
    ...
    // Glob WhatTheRack/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("WhatTheRack/src"), &filter_out, &plugins_dir, &mut build, 0);
