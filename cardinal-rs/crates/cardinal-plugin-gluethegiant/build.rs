...
fn main() {
    ...
    build.define("init", "init__GlueTheGiant");
    ...
    // Glob GlueTheGiant/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("GlueTheGiant/src"), &filter_out, &plugins_dir, &mut build, 0);
