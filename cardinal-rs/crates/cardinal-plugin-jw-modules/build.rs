...
fn main() {
    ...
    collect_sources(&plugins_dir.join("JW-Modules/lib/oscpack/ip"), &_filter_out, &plugins_dir, &mut build, 0);
    collect_sources(&plugins_dir.join("JW-Modules/lib/oscpack/ip/posix"), &_filter_out, &plugins_dir, &mut build, 0);
