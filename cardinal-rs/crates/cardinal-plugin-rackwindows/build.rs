...
fn main() {
    ...
    build.define("init", "init__rackwindows");
    ...
    // Glob rackwindows/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("rackwindows/src"), &filter_out, &plugins_dir, &mut build, 0);
