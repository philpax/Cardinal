...
fn main() {
    ...
    build.define("init", "init__Fundamental");
    ...
    // Glob Fundamental/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("Fundamental/src"), &filter_out, &plugins_dir, &mut build, 0);
