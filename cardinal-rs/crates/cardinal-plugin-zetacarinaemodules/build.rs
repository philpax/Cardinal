...
fn main() {
    ...
    build.define("init", "init__ZetaCarinaeModules");
    ...
    // Glob ZetaCarinaeModules/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("ZetaCarinaeModules/src"), &filter_out, &plugins_dir, &mut build, 0);
