...
fn main() {
    ...
    build.define("init", "init__Extratone");
    ...
    // Glob Extratone/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("Extratone/src"), &filter_out, &plugins_dir, &mut build, 0);
