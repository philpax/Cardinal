...
fn main() {
    ...
    // Glob LomasModules/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("LomasModules/src"), &filter_out, &plugins_dir, &mut build, 0);
