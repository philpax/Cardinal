...
fn main() {
    ...
    build.define("init", "init__eightfold");
    ...
    // Glob eightfold/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("eightfold/src"), &filter_out, &plugins_dir, &mut build, 0);
