...
fn main() {
    ...
    build.define("init", "init__sonusmodular");
    ...
    // Glob sonusmodular/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("sonusmodular/src"), &filter_out, &plugins_dir, &mut build, 0);
