...
fn main() {
    ...
    build.define("init", "init__GoodSheperd");
    ...
    // Glob GoodSheperd/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("GoodSheperd/src"), &filter_out, &plugins_dir, &mut build, 0);
