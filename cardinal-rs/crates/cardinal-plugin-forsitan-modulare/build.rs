...
fn main() {
    ...
    build.define("init", "init__forsitan");
    ...
    // Glob forsitan-modulare/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("forsitan-modulare/src"), &filter_out, &plugins_dir, &mut build, 0);
