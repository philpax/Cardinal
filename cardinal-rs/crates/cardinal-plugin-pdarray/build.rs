...
fn main() {
    ...
    let _filter_out: Vec<String> = vec![
        "PdArray/src/plugin.cpp".to_string(),
    ];
    ...
    build.file(std::path::Path::new("/home/user/Cardinal/cardinal-rs/crates/cardinal-plugin-pdarray/init_wrapper.cpp"));
    ...
    println!("cargo:rustc-link-lib=static:+whole-archive=cardinal_plugin_pdarray");
}
