...
fn main() {
    ...
    // Glob h4n4-modules/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("h4n4-modules/src"), &filter_out, &plugins_dir, &mut build, 0);
