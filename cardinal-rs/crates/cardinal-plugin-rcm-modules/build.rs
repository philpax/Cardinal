...
fn main() {
    ...
    collect_sources(&plugins_dir.join("rcm-modules/src"), &_filter_out, &plugins_dir, &mut build, 0);
    collect_sources(&plugins_dir.join("rcm-modules/src/PianoRoll"), &_filter_out, &plugins_dir, &mut build, 0);
