...
fn main() {
    ...
    build.define("init", "init__stocaudio");
    ...
    // Glob stocaudio/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("stocaudio/src"), &filter_out, &plugins_dir, &mut build, 0);
