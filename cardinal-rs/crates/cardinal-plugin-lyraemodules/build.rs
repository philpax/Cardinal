...
fn main() {
    ...
    // Glob LyraeModules/src/**/*.cpp|cc|c (recursive)
    ...
    collect_sources(&plugins_dir.join("LyraeModules/src"), &filter_out, &plugins_dir, &mut build, 0);
